...
public class DBConnection {
	...
	// handle trivial exception in database layer
	...
	// What it does is to query the history table and get all the restaurants
	// (ids) from the table.
	// 用set来去重，我们基于catagory推荐
	...
	// searchRestaurant API 具体implementation
	public JSONArray SearchRestaurants(String userId, double lat, double lon) {
		try {
			...
			for (int i = 0; i < array.length(); i++) {
				...
				// 放在mySQL里， executeUpdateStatement在上面写好，并判断了excption
			...
			// convert to JSONArray again for front-end
